...
Indexed-family refactors from `abs_conv.ac` are complete. Finite subobject finiteness transfers are deferred until the algebraic hierarchy introduces new subobject types; quotient constructions are deferred until the algebraic quotient API decision is made.
